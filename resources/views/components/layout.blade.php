            ...
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center justify-between w-full">
                        <div class="shrink-0 gap-2 flex items-center">
                            <img class="size-10" src="{{ asset('logo.png') }}" alt="JobHub">
                            <h1 class="text-white font-serif text-xl">JobHub</h1>
                        </div>
                        @auth
                            ...
                            <form method="POST" action="/logout" class="justify-end">
                                @csrf
                                <button class="bg-red-600 rounded-md px-3 py-2 text-sm font-medium mr-2">Log Out</button>
                            </form>
        ...
        <header class="bg-white shadow">
            @auth
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between">
                    ...
                    <a href="/jobs/create"
                        class="  border rounded-md px-3 py-2 text-sm font-medium bg-gray-800 text-white">Create a new
                        job</a>
                @endauth
            </div>
        </header>
